...
GRADS_SG_GEN = [('<N1A>baarimikko+Sg+Gen', '<N1A>baarimiko+Sg+Gen'),
...
GRADS_PL_NOM = [('<N1A>baarimikko+Pl+Nom', '<N1A>baarimiko+Pl+Nom'),
...
@pytest.mark.parametrize("test_input, expected", GRADS_SG_GEN)
...
@pytest.mark.parametrize("test_input, expected", GRADS_PL_NOM)
